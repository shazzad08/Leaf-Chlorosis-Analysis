...
def analyze_image(image_path, output_folder="static"):
    ...
    chlorosis_index = yellow_pixels / total_pixels
    ...
    confidence = ((total_pixels / image_pixels) * 100) - 6
    ...
    leaf_path = os.path.join(output_folder, f"{uid}_leaf.png")
    yellow_path = os.path.join(output_folder, f"{uid}_yellow.png")
    overlay_path = os.path.join(output_folder, f"{uid}_overlay.png")
    hist_path = os.path.join(output_folder, f"{uid}_hist.png")
    ...
    return {
        ...
        "leaf_img": f"/static/{uid}_leaf.png",
        "yellow_img": f"/static/{uid}_yellow.png",
        "overlay_img": f"/static/{uid}_overlay.png",
        "hist_img": f"/static/{uid}_hist.png"
    }